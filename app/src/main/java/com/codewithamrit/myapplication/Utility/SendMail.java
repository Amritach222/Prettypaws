...
public class SendMail extends AsyncTask {
    ...
    private CallBackCheckLike checkSuccess;
    public SendMail(Context context, String email, String subject, String message, CallBackCheckLike checkSuccess){
    ...
    protected void onPostExecute(Object o) {
        ...
        checkSuccess.onSuccessResponse(true);
    }
